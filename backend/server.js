...
app.get("/", (req, res) =>{
	res.sendFile(path.join(`${__dirname}/../frontend/index.html`) )  //igy szolgaljuk ki az index filet
})
...
const serverFunction = (req, res) => {
	...
	const errorHTML = 'Ez nem letezik'
	...
	if(err){
		...
		fs.readFile(filePath, (err, data) => {
			if(err) {
				...
				console.log("az index.html rendben kiszolgalodott");
				res.end(data);
			}
		});
	}
